...
public class ExcelUtils {
	...
	public String getCellData(String xlsheet, int rownum,int colnum) throws IOException{
		...
		data =formatter.formatCellValue(cell); //Returns the formatted value of a cell as a string regardless of the type of cell.
		}
		catch (Exception e){
		data="";
		}
	...
	public void setCellData (String xlsheet, int rownum,int colnum,String data) throws IOException{
		...
		wb=new XSSFWorkbook(fi);
		if(wb.getSheetIndex(xlsheet)==-1) {  //if sheet does not exist create new sheet
